...
var setScrapper = function setScrapper(scrappersByName) {
  scrappersByName['www.breitbart.com'] = function (document) {
    // LINK
    var excerpt = ([].concat(_toConsumableArray((document.querySelector('article.the-article') || _utils.defaultElement).querySelector('div.entry-content').defaultElement.querySelectorAll('p'))).find(function (pElement) {
